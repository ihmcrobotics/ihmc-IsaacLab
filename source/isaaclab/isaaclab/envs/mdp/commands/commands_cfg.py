...
from .velocity_command import NormalVelocityCommand, UniformVelocityCommand, UniformVelocityPlusHeightCommand
...
@configclass
class UniformVelocityPlusHeightCommandCfg(CommandTermCfg):
    """Configuration for the uniform velocity command generator."""

    class_type: type = UniformVelocityPlusHeightCommand
    ...
    class Ranges:
        ...
        """Range for the linear-z position target command (in m)."""
